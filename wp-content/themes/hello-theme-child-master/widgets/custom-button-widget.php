...
class Custom_Button_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Custom Button', 'entyce_base_theme' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'button_alignment',
            [
                'label' => __( 'Alignment', 'entyce_base_theme' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'align-center',
                'options' => [
                    'align-left' => __( 'Left', 'entyce_base_theme' ),
                    'align-center' => __( 'Center', 'entyce_base_theme' ),
                ],
            ]
        );
    ...
    protected function render() {
        ...
        ' button-' . $settings['button_alignment']
        );
