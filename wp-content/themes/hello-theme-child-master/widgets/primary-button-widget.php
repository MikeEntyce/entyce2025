<?php
class Primary_Button_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Primary Button', 'entyce_base_theme' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'global' => [
                    'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_PRIMARY,  // Optional, set a default global color
                ],
                'selectors' => [
    ...
    protected function render() {
        ...
        $color_value = !empty( $settings['background_color'] ) ? $settings['background_color'] : 'var(--e-global-color-primary)';
